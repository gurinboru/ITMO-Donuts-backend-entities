...
from resources import User, Users, UserPost, Order, Orders, OrdersByUser, OrderPost
...
api.add_resource(Orders, api_base_url + "orders/")
api.add_resource(OrdersByUser, api_base_url + "orders/<int:user_id>")
